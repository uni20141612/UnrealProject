...
#include "SecondProject/Public/Character/Player/Animation/NotifyState/AttackNotifyState.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	SECONDPROJECT_API UClass* Z_Construct_UClass_UAttackNotifyState_NoRegister();
	SECONDPROJECT_API UClass* Z_Construct_UClass_UAttackNotifyState();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAttackNotifyState_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "Character/Player/Animation/NotifyState/AttackNotifyState.h" },
		{ "ModuleRelativePath", "Public/Character/Player/Animation/NotifyState/AttackNotifyState.h" },
	};
#endif
	...
	IMPLEMENT_CLASS(UAttackNotifyState, 726160437);
	template<> SECONDPROJECT_API UClass* StaticClass<UAttackNotifyState>()
	{
		return UAttackNotifyState::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAttackNotifyState(Z_Construct_UClass_UAttackNotifyState, &UAttackNotifyState::StaticClass, TEXT("/Script/SecondProject"), TEXT("UAttackNotifyState"), false, nullptr, nullptr, nullptr);
