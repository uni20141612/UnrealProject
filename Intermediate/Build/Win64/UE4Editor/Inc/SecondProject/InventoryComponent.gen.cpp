...
// End Cross Module References
	struct Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature_Statics
	{
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature_Statics::NewProp_image = { "image", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_SecondProject_eventAddQuick_Parms, image), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature_Statics::NewProp_count_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature_Statics::NewProp_count = { "count", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_SecondProject_eventAddQuick_Parms, count), METADATA_PARAMS(Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature_Statics::NewProp_count_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature_Statics::NewProp_count_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature_Statics::NewProp_image,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature_Statics::NewProp_count,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Character/Player/Component/InventoryComponent.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_SecondProject, nullptr, "AddQuick__DelegateSignature", nullptr, nullptr, sizeof(_Script_SecondProject_eventAddQuick_Parms), Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_SecondProject_AddQuick__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UDelegateFunction_SecondProject_UseQuick__DelegateSignature_Statics
	{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_SecondProject_UseQuick__DelegateSignature_Statics::NewProp_count_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_SecondProject_UseQuick__DelegateSignature_Statics::NewProp_count = { "count", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_SecondProject_eventUseQuick_Parms, count), METADATA_PARAMS(Z_Construct_UDelegateFunction_SecondProject_UseQuick__DelegateSignature_Statics::NewProp_count_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SecondProject_UseQuick__DelegateSignature_Statics::NewProp_count_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_SecondProject_UseQuick__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SecondProject_UseQuick__DelegateSignature_Statics::NewProp_count,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_SecondProject_UseQuick__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Character/Player/Component/InventoryComponent.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_SecondProject_UseQuick__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_SecondProject, nullptr, "UseQuick__DelegateSignature", nullptr, nullptr, sizeof(_Script_SecondProject_eventUseQuick_Parms), Z_Construct_UDelegateFunction_SecondProject_UseQuick__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SecondProject_UseQuick__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_SecondProject_UseQuick__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SecondProject_UseQuick__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_SecondProject_UseQuick__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_SecondProject_UseQuick__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
